...
import {BaseModel} from "@/lib/model/storage/baseStorage";
...
class OrderService {
  orderModel: BaseModel<Order>;
  cartModel: BaseModel<UserCart>;
  bonusModel: BaseModel<BonusCard>;
  productsModel: BaseModel<Product>;

  constructor(orderModel: BaseModel<Order>, cartModel: BaseModel<UserCart>, bonusModel: BaseModel<BonusCard>, productsModel: BaseModel<Product>) {
